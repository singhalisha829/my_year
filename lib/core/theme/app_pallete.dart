...
class AppPalette {
  ...
  static const Color neonYellowLight = Color(0xFFEAB308); // Warm amber yellow
  static const Color neonPurpleLight = Color(0xFF7C3AED); // Softer violet
  static const Color neonOrangeLight = Color(0xFFEA580C); // Burnt orange
